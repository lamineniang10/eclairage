...
➡[Tous les détails sont disponibles dans le notebook](https://github.com/lamineniang10/eclairage/blob/main/bokidiawe_lumiere_et_population.ipynb) et les images dans le dossier `docs`
### Contributions
